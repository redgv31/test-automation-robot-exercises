...
View Clients Page
    SELLIB.Wait Until Element Is Visible           ${PAGE_CLIENT['TOP_MENU_CLIENTS']}
    SELLIB.Mouse Over                              ${PAGE_CLIENT['TOP_MENU_CLIENTS']}
    SELLIB.Wait Until Element Is Visible           ${PAGE_CLIENT['SUB_MENU_CLIENTS_LINK']}
    SELLIB.Mouse Over                              ${PAGE_CLIENT['SUB_MENU_CLIENTS_LINK']}
    SELLIB.Click Element                           ${PAGE_CLIENT['SUB_MENU_CLIENTS_LINK']}
    SELLIB.Wait Until Element Is Visible           ${PAGE_CLIENT['TITLE_LIST_OF_CLIENTS']}
    SELLIB.Wait Until Page Contains                ${TEXT_LIST_OF_CLIENTS['TITLE_LIST_OF_CLIENTS']}
    SELLIB.Wait Until Page Contains Element        ${PAGE_CLIENT['SYMBOL_LAST_PAGE_NUMBER']}